...
def two_circles():
    ...
    window.render()
    circle=rg.Circle(rg.Point(50,20),10)
    circle_2=rg.Circle(rg.Point(60,100),40)
    circle_2.fill_color='purple'
...
def lines():
    window=rg.RoseWindow()
    line_1=rg.Line(rg.Point(0,0),rg.Point(400,400))
    line_2=rg.Line(rg.Point(0,200),rg.Point(200,200))
